...
class Releases {
	...
	availableToTester(ownerName, appName, options, optionalCallback) {
		...
		if (!optionalCallback) {
			...
			return self._availableToTester(
				ownerName,
				appName,
				options,
				optionalCallback,
	...
	getLatestByDistributionGroupWithHttpOperationResponse(
		...
		let self = this;
		return new Promise((resolve, reject) => {
			self._getLatestByDistributionGroup(
				ownerName,
				appName,
				distributionGroupName,
				releaseId,
	...
	getLatestByDistributionGroup(
		...
		if (!optionalCallback) {
			...
			return self._getLatestByDistributionGroup(
				ownerName,
				appName,
				distributionGroupName,
				releaseId,
	...
	deleteWithDistributionGroupIdWithHttpOperationResponse(
		...
		let self = this;
		return new Promise((resolve, reject) => {
			self._deleteWithDistributionGroupId(
				ownerName,
				appName,
				distributionGroupName,
				releaseId,
	...
	deleteWithDistributionGroupId(
		...
		if (!optionalCallback) {
			...
			return self._deleteWithDistributionGroupId(
				ownerName,
				appName,
				distributionGroupName,
				releaseId,
	...
	listByDistributionGroup(
		...
		if (!optionalCallback) {
			...
			return self._listByDistributionGroup(
				distributionGroupName,
				ownerName,
				appName,
				options,
