	...
	try {
		...
		if (Array.isArray(versions)) {
			for (let i = 0; i < versions.length; i++) {
				if (
					versions[i] !== null &&
					versions[i] !== undefined &&
					typeof versions[i].valueOf() !== "string"
				) {
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _sessionDurationsDistributionMethod(
	start,
	ownerName,
	appName,
	options,
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _eventPropertiesMethod(
	eventName,
	ownerName,
	appName,
	options,
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _eventDeviceCountMethod(
	eventName,
	start,
	ownerName,
	appName,
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _eventPerSessionCount(
	eventName,
	start,
	ownerName,
	appName,
	...
	try {
		...
		if (Array.isArray(eventName)) {
			for (let i1 = 0; i1 < eventName.length; i1++) {
				if (
					eventName[i1] !== null &&
					eventName[i1] !== undefined &&
					typeof eventName[i1].valueOf() !== "string"
				) {
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _distributionReleaseCounts(
	ownerName,
	appName,
	releases,
	options,
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _crashFreeDevicePercentagesMethod(
	start,
	ownerName,
	appName,
	options,
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _crashGroupOperatingSystemCounts(
	crashGroupId,
	version,
	ownerName,
	appName,
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _crashGroupModelCounts(
	crashGroupId,
	version,
	ownerName,
	appName,
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _createOrUpdateAudience(
	audienceName,
	audience,
	ownerName,
	appName,
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _listDevicePropertyValues(
	propertyName,
	ownerName,
	appName,
	options,
	...
	try {
		...
		if (
			contains !== null &&
			contains !== undefined &&
			typeof contains.valueOf() !== "string"
		) {
...
function _listAudiences(ownerName, appName, options, callback) {
	...
	try {
		if (
			...
			typeof includeDisabled !== "boolean"
		) {
...
class Analytics {
	...
	constructor(client) {
		...
		this._sessionDurationsDistributionMethod =
			_sessionDurationsDistributionMethod;
	 ...
	 * @reject {Error} - The error object.
	 */
	perDeviceCountsWithHttpOperationResponse(
		start,
		interval,
		ownerName,
		appName,
	 ...
	 * @reject {Error} - The error object.
	 */
	sessionDurationsDistributionMethodWithHttpOperationResponse(
		start,
		ownerName,
		appName,
		options,
	 ...
	 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
	 */
	sessionDurationsDistributionMethod(
		start,
		ownerName,
		appName,
		options,
	 ...
	 * @reject {Error} - The error object.
	 */
	sessionCountsWithHttpOperationResponse(
		start,
		interval,
		ownerName,
		appName,
	 ...
	 * @reject {Error} - The error object.
	 */
	operatingSystemCountsWithHttpOperationResponse(
		start,
		ownerName,
		appName,
		options,
	 ...
	 * @reject {Error} - The error object.
	 */
	languageCountsWithHttpOperationResponse(
		start,
		ownerName,
		appName,
		options,
	 ...
	 * @reject {Error} - The error object.
	 */
	eventPropertyCountsWithHttpOperationResponse(
		eventName,
		eventPropertyName,
		start,
		ownerName,
	 ...
	 * @reject {Error} - The error object.
	 */
	eventPropertiesMethodWithHttpOperationResponse(
		eventName,
		ownerName,
		appName,
		options,
	 ...
	 * @reject {Error} - The error object.
	 */
	eventCountMethodWithHttpOperationResponse(
		eventName,
		start,
		ownerName,
		appName,
	 ...
	 * @reject {Error} - The error object.
	 */
	eventDeviceCountMethodWithHttpOperationResponse(
		eventName,
		start,
		ownerName,
		appName,
	 ...
	 * @reject {Error} - The error object.
	 */
	eventPerSessionCountWithHttpOperationResponse(
		eventName,
		start,
		ownerName,
		appName,
	 ...
	 * @reject {Error} - The error object.
	 */
	eventPerDeviceCountWithHttpOperationResponse(
		eventName,
		start,
		ownerName,
		appName,
	 ...
	 * @reject {Error} - The error object.
	 */
	eventsDeleteWithHttpOperationResponse(
		eventName,
		ownerName,
		appName,
		options,
	 ...
	 * @reject {Error} - The error object.
	 */
	eventsDeleteLogsWithHttpOperationResponse(
		eventName,
		ownerName,
		appName,
		options,
	 ...
	 * @reject {Error} - The error object.
	 */
	distributionReleaseCountsWithHttpOperationResponse(
		ownerName,
		appName,
		releases,
		options,
	 ...
	 * @reject {Error} - The error object.
	 */
	crashFreeDevicePercentagesMethodWithHttpOperationResponse(
		start,
		ownerName,
		appName,
		options,
	 ...
	 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
	 */
	crashFreeDevicePercentagesMethod(
		start,
		ownerName,
		appName,
		options,
	 ...
	 * @reject {Error} - The error object.
	 */
	crashGroupTotalsWithHttpOperationResponse(
		crashGroupId,
		version,
		ownerName,
		appName,
	 ...
	 * @reject {Error} - The error object.
	 */
	crashGroupOperatingSystemCountsWithHttpOperationResponse(
		crashGroupId,
		version,
		ownerName,
		appName,
	 ...
	 * @reject {Error} - The error object.
	 */
	crashGroupModelCountsWithHttpOperationResponse(
		crashGroupId,
		version,
		ownerName,
		appName,
	 ...
	 * @reject {Error} - The error object.
	 */
	crashGroupCountsWithHttpOperationResponse(
		crashGroupId,
		version,
		start,
		ownerName,
	 ...
	 * @reject {Error} - The error object.
	 */
	crashGroupsTotalsWithHttpOperationResponse(
		ownerName,
		appName,
		crashGroups,
		options,
	 ...
	 * @reject {Error} - The error object.
	 */
	crashCountsMethodWithHttpOperationResponse(
		start,
		ownerName,
		appName,
		options,
	 ...
	 * @reject {Error} - The error object.
	 */
	audienceNameExistsWithHttpOperationResponse(
		audienceName,
		ownerName,
		appName,
		options,
	 ...
	 * @reject {Error} - The error object.
	 */
	deleteAudienceWithHttpOperationResponse(
		audienceName,
		ownerName,
		appName,
		options,
	 ...
	 * @reject {Error} - The error object.
	 */
	getAudienceWithHttpOperationResponse(
		audienceName,
		ownerName,
		appName,
		options,
	 ...
	 * @reject {Error} - The error object.
	 */
	createOrUpdateAudienceWithHttpOperationResponse(
		audienceName,
		audience,
		ownerName,
		appName,
	 ...
	 * @reject {Error} - The error object.
	 */
	listDevicePropertyValuesWithHttpOperationResponse(
		propertyName,
		ownerName,
		appName,
		options,
	 ...
	 * @reject {Error} - The error object.
	 */
	testAudienceWithHttpOperationResponse(
		audience,
		ownerName,
		appName,
		options,
