...
function _update(crashGroupId, ownerName, appName, options, callback) {
	...
	try {
		...
		if (
			...
			typeof annotation.valueOf() !== "string"
		) {
...
function _list(ownerName, appName, options, callback) {
	...
	try {
		...
		if (
			groupType !== null &&
			groupType !== undefined &&
			typeof groupType.valueOf() !== "string"
		) {
		...
		if (
			...
			typeof groupStatus.valueOf() !== "string"
		) {
			throw new Error("groupStatus must be of type string.");
		}
		if (
			groupTextSearch !== null &&
			groupTextSearch !== undefined &&
			typeof groupTextSearch.valueOf() !== "string"
		) {
		...
		if (
			...
			typeof continuationToken.valueOf() !== "string"
		) {
