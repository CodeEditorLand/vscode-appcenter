...
class Devices {
	...
	registerUserForDevice(userId, body, options, optionalCallback) {
		...
		if (!optionalCallback) {
			...
			return self._registerUserForDevice(
				userId,
				body,
				options,
				optionalCallback,
	...
	getReleaseUpdateDevicesStatusWithHttpOperationResponse(
		...
		let self = this;
		return new Promise((resolve, reject) => {
			self._getReleaseUpdateDevicesStatus(
				releaseId,
				resignId,
				ownerName,
				appName,
	...
	getReleaseUpdateDevicesStatus(
		...
		if (!optionalCallback) {
			...
			return self._getReleaseUpdateDevicesStatus(
				releaseId,
				resignId,
				ownerName,
				appName,
	...
	getUpdateDevicesStatus(
		...
		if (!optionalCallback) {
			...
			return self._getUpdateDevicesStatus(
				distributionGroupName,
				resignId,
				ownerName,
				appName,
