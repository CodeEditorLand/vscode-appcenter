					...
					const resultMapper = {
						...
						type: {
							...
							element: {
								required: false,
								serializedName:
									"AzureSubscriptionResponseElementType",
								type: {
									name: "Composite",
...
function _linkForApp(ownerName, appName, subscriptionId, options, callback) {
	...
	if (subscriptionId !== null && subscriptionId !== undefined) {
		azureSubscriptionToAppData = new client.models[
	...
	try {
		if (
			azureSubscriptionToAppData !== null &&
			azureSubscriptionToAppData !== undefined
		) {
...
class AzureSubscription {
	...
	listForUserWithHttpOperationResponse(options) {
		const client = this.client;
		return new Promise((resolve, reject) => {
			this._listForUser(options, (err, result, request, response) => {
	...
	listForUser(options, optionalCallback) {
		...
		if (optionalCallback) {
			return this._listForUser(options, optionalCallback);
		} else {
			return new Promise((resolve, reject) => {
				this._listForUser(options, (err, result, request, response) => {
					if (err) {
	 ...
	 * @reject {Error} - The error object.
	 */
	deleteForAppWithHttpOperationResponse(
		azureSubscriptionId,
		ownerName,
		appName,
		options,
	 ...
	 * @reject {Error} - The error object.
	 */
	linkForAppWithHttpOperationResponse(
		ownerName,
		appName,
		subscriptionId,
		options,
