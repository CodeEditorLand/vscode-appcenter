 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _getHockeyAppCrashForwardingStatus(
	ownerName,
	appName,
	options,
	callback,
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _updateHockeyAppCrashForwarding(
	ownerName,
	appName,
	options,
	callback,
	...
	let enableForwarding =
		options && options.enableForwarding !== undefined
			? options.enableForwarding
			: undefined;
	// Validate
	try {
		if (
		...
		if (
			...
			enableForwarding !== undefined &&
			typeof enableForwarding !== "boolean"
		) {
...
function _listSessionLogs(crashId, ownerName, appName, options, callback) {
	...
	try {
		if (
			crashId === null ||
			crashId === undefined ||
			typeof crashId.valueOf() !== "string"
		) {
			throw new Error(
				"crashId cannot be null or undefined and it must be of type string.",
			);
		}
		if (
			ownerName === null ||
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _getCrashTextAttachmentContent(
	crashId,
	attachmentId,
	ownerName,
	appName,
	...
	try {
		...
		if (
			...
			typeof attachmentId.valueOf() !== "string"
		) {
			throw new Error(
				"attachmentId cannot be null or undefined and it must be of type string.",
			);
		}
		if (
			ownerName === null ||
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _getCrashAttachmentLocation(
	crashId,
	attachmentId,
	ownerName,
	appName,
...
function _getStacktrace(
	...
	try {
		...
		if (
			groupingOnly !== null &&
			groupingOnly !== undefined &&
			typeof groupingOnly !== "boolean"
		) {
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _getNativeCrashDownload(
	crashGroupId,
	crashId,
	ownerName,
	appName,
...
function _get(crashGroupId, crashId, ownerName, appName, options, callback) {
	...
	let includeReport =
		options && options.includeReport !== undefined
			? options.includeReport
			: false;
	let includeLog =
		options && options.includeLog !== undefined
			? options.includeLog
			: false;
	let includeDetails =
		options && options.includeDetails !== undefined
			? options.includeDetails
			: false;
	let includeStacktrace =
		options && options.includeStacktrace !== undefined
	...
	try {
		...
		if (
			...
			typeof includeStacktrace !== "boolean"
		) {
	...
	if (includeReport !== null && includeReport !== undefined) {
		queryParameters.push(
			"include_report=" + encodeURIComponent(includeReport.toString()),
		);
	}
	if (includeLog !== null && includeLog !== undefined) {
		queryParameters.push(
			"include_log=" + encodeURIComponent(includeLog.toString()),
		);
	}
	if (includeDetails !== null && includeDetails !== undefined) {
		queryParameters.push(
			"include_details=" + encodeURIComponent(includeDetails.toString()),
		);
	}
	if (includeStacktrace !== null && includeStacktrace !== undefined) {
		queryParameters.push(
			"include_stacktrace=" +
				encodeURIComponent(includeStacktrace.toString()),
		);
	}
	if (groupingOnly !== null && groupingOnly !== undefined) {
		queryParameters.push(
...
function _list(crashGroupId, ownerName, appName, options, callback) {
	...
	let includeLog =
		options && options.includeLog !== undefined
			...
			: false;
	let dateFrom =
		options && options.dateFrom !== undefined
			? options.dateFrom
			: undefined;
	let dateTo =
		options && options.dateTo !== undefined ? options.dateTo : undefined;
	let appVersion =
		options && options.appVersion !== undefined
			? options.appVersion
			: undefined;
	let errorType =
		options && options.errorType !== undefined
			? options.errorType
			: undefined;
	// Validate
	try {
		...
		if (
			...
			!(
				...
				(typeof dateFrom.valueOf() === "string" &&
		...
		if (
			...
			typeof appVersion.valueOf() !== "string"
		) {
		...
		if (
			errorType !== null &&
			errorType !== undefined &&
			typeof errorType.valueOf() !== "string"
		) {
	...
	if (dateFrom !== null && dateFrom !== undefined) {
		queryParameters.push(
			"date_from=" + encodeURIComponent(client.serializeObject(dateFrom)),
		);
	}
	if (dateTo !== null && dateTo !== undefined) {
		queryParameters.push(
			"date_to=" + encodeURIComponent(client.serializeObject(dateTo)),
		);
	}
...
class Crashes {
	...
	constructor(client) {
		...
		this._getHockeyAppCrashForwardingStatus =
			_getHockeyAppCrashForwardingStatus;
	...
	getHockeyAppCrashForwardingStatusWithHttpOperationResponse(
		...
		let self = this;
		return new Promise((resolve, reject) => {
			self._getHockeyAppCrashForwardingStatus(
				ownerName,
				appName,
				options,
				(err, result, request, response) => {
	 ...
	 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
	 */
	getHockeyAppCrashForwardingStatus(
		ownerName,
		appName,
		options,
		optionalCallback,
		...
		if (!optionalCallback) {
			...
			return self._getHockeyAppCrashForwardingStatus(
				ownerName,
				appName,
				options,
				optionalCallback,
	...
	updateHockeyAppCrashForwardingWithHttpOperationResponse(
		...
		let self = this;
		return new Promise((resolve, reject) => {
			self._updateHockeyAppCrashForwarding(
				ownerName,
				appName,
				options,
				(err, result, request, response) => {
	 ...
	 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
	 */
	updateHockeyAppCrashForwarding(
		ownerName,
		appName,
		options,
		optionalCallback,
		...
		if (!optionalCallback) {
			...
			return self._updateHockeyAppCrashForwarding(
				ownerName,
				appName,
				options,
				optionalCallback,
	...
	getAppCrashesInfo(ownerName, appName, options, optionalCallback) {
		...
		if (!optionalCallback) {
			...
			return self._getAppCrashesInfo(
				ownerName,
				appName,
				options,
				optionalCallback,
	 ...
	 * @reject {Error} - The error object.
	 */
	listSessionLogsWithHttpOperationResponse(
		crashId,
		ownerName,
		appName,
		options,
	 ...
	 * @reject {Error} - The error object.
	 */
	getCrashTextAttachmentContentWithHttpOperationResponse(
		crashId,
		attachmentId,
		ownerName,
		appName,
		...
		let self = this;
		return new Promise((resolve, reject) => {
			self._getCrashTextAttachmentContent(
				crashId,
				attachmentId,
				ownerName,
				appName,
	...
	getCrashTextAttachmentContent(
		...
		if (!optionalCallback) {
			...
			return self._getCrashTextAttachmentContent(
				crashId,
				attachmentId,
				ownerName,
				appName,
	 ...
	 * @reject {Error} - The error object.
	 */
	getCrashAttachmentLocationWithHttpOperationResponse(
		crashId,
		attachmentId,
		ownerName,
		appName,
		...
		let self = this;
		return new Promise((resolve, reject) => {
			self._getCrashAttachmentLocation(
				crashId,
				attachmentId,
				ownerName,
				appName,
	...
	getCrashAttachmentLocation(
		...
		if (!optionalCallback) {
			...
			return self._getCrashAttachmentLocation(
				crashId,
				attachmentId,
				ownerName,
				appName,
	 ...
	 * @reject {Error} - The error object.
	 */
	listAttachmentsWithHttpOperationResponse(
		crashId,
		ownerName,
		appName,
		options,
	 ...
	 * @reject {Error} - The error object.
	 */
	getRawCrashLocationWithHttpOperationResponse(
		crashGroupId,
		crashId,
		ownerName,
		appName,
	...
	getRawCrashLocation(
		...
		if (!optionalCallback) {
			...
			return self._getRawCrashLocation(
				crashGroupId,
				crashId,
				ownerName,
				appName,
	...
	getNativeCrashDownload(
		...
		if (!optionalCallback) {
			...
			return self._getNativeCrashDownload(
				crashGroupId,
				crashId,
				ownerName,
				appName,
	 ...
	 * @reject {Error} - The error object.
	 */
	getNativeCrashWithHttpOperationResponse(
		crashGroupId,
		crashId,
		ownerName,
		appName,
