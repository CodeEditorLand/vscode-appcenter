...
export class Messages {
	...
	public static SimulateCrashesProgressMessage: string =
		"Generating crash data for you...";
	public static CreatingDistributionStatusBarProgressMessage: string =
		"Creating distribution groups...";
	public static SimulateCrashesSendProgressMessage: string =
		"Sending crash data to App Center...";
	public static ReleasingUpdateContentsProgressMessage: string =
		"Sending update to CodePush...";
	public static FetchDeploymentsProgressMessage: string =
		"Fetching CodePush deployments for you...";
	public static GetAppsListProgressMessage: string = "Getting apps...";
	public static ConnectingRepoToBuildServiceStatusBarProgressMessage: string =
		"Configuring cloud build services...";
	public static CreateBranchConfigAndKickOffBuildProgressMessage: string =
		"Starting a fresh cloud build...";
	public static VSCodeProgressLoadingTitle: string = "Loading...";
	public static InstallCodePushProgressMessage: string =
		"Installing CodePush...";
	public static InstallAppCenterProgressMessage: string =
		"Installing App Center modules...";
	public static LinkCodePushProgressMessage: string =
		"Linking React Native Module for CodePush...";
	public static CheckIfAppsExistProgressMessage: string =
		"Checking if project name is already in use...";
	public static LoadingVSTSProjectsProgressMessage: string =
		"Loading VSTS projects for you...";
	public static LoadingStatusBarProgressMessage: string =
		"Loading some information for you...";
	public static CreateRNProjectProgressMessage: string =
		"Creating a starting point for your project...";
	public static PushToRemoteRepoProgressMessage: string =
		"Pushing changes to your new repository...";
	public static CreatingCodePushDeploymentsProgressMessage: string =
		"Creating CodePush deployments...";
	public static RunNPMInstallProgressMessage: string =
		"Installing package dependencies...";
	public static FetchingDevicesProgressMessage: string =
		"Fetching devices...";
	public static CleaningBuildProgressMessage: string =
		"Cleaning build directory...";
	public static PreparingBuildProgressMessage: string =
		"Preparing build for testing...";
	public static MakingBundleProgressMessage: string = "Making a bundle...";
	public static UploadingAndRunningTestsProgressMessage: string =
		"Uploading and running tests on App Center portal...";
	public static CheckingAppCenterCliProgressMessage: string =
		"Checking for AppCenter CLI installation...";
	public static GettingAppInfoProgressMessage: string =
		"Retrieving app info...";
	public static DetectingAppVersionProgressMessage: string =
		"Locating app version...";
	public static RunningBundleCommandProgressMessage: string =
		"Creating a new bundle...";
	public static ArchivingUpdateContentsProgressMessage: string =
		"Compressing new bundle...";
	...
	public static StatusBarAlreadyShownMessage: string =
		"The status bar is already shown. Look, it's in the bottom left corner of the window, with your name/app name on it!";
	public static StatusBarAlreadyHiddenMessage: string =
		"You've already hidden the status bar.";
	...
	public static CodePushLinkedMessage: string =
		"CodePush has been successfully linked to your application!";
	public static PleaseLoginViaBrowserMessage: string =
	...
	public static CrashesSimulatedMessage: string =
		"The crash has been successfully generated and sent to App Center!";
	public static PodsNotInstalledMessage: string =
	...
	public static AppCenterBeforeLinkMessage: string =
	...
	public static ChangedMandatoryMessage(newMandatoryValue: boolean): string {
		return `Changed release to ${
			newMandatoryValue ? "Mandatory" : "NOT Mandatory"
		}.`;
	}
...
The current app is '${currentAppName}'.`;
	...
	public static NoDeploymentsWarning: string =
		"There are no deployments for current app.";
	public static InvalidCurrentAppNameWarning: string =
		"Sorry, the app name isn't valid.";
	public static UserIsNotLoggedInWarning: string =
		"You are not logged into App Center.";
	public static InvalidAppVersionParamWarning: string =
		"Sorry, the provided app version isn't valid. It should be in a valid semver vesion format.";
	public static NotCodePushProjectWarning: string =
	...
	public static GitIsNotInstalledWarning: string =
		"It looks like you don't have a local git client installed.";
	public static ProjectNameIsNotValidWarning: string =
		"Sorry, the project name your entered is invalid. Make sure its starts with a letter and has no whitespaces in it.";
	public static VstsCredsNotValidWarning: string =
		"VSTS credentials are not valid.";
	public static DirectoryIsNotEmptyForNewProjectWarning: string =
		"Sorry, you can only start a new project inside an empty folder.";
	public static NoProjectRootFolderFoundWarning: string =
		"Please open a project before using this command.";
	...
	public static FailedToMakeCodePushRelease: string =
	...
	public static FailedToConnectRepoToBuildService: string =
		"Failed to connect the repository to the build service. Check out the Output window for more details.";
	public static FailedToConfigureBranchAndStartNewBuild: string =
		"Failed to configure the branch for build. Check out the Output window for more details.";
	public static FailedToCreateDistributionGroup: string =
		"Failed to create distribution groups. Check out the Output window for more details.";
	public static FailedToCreateRNProjectMsg: string =
		"An unexpected error occurred while fetching the sample project.";
	public static FailedToAddRemoteRepositoryMsg: string =
		"Sorry, failed to add remote repository.";
	public static FailedToGetSelectedUserOrOrganizationMsg: string =
		"Sorry, failed to get selected account information.";
	public static FailedToProvideRepositoryNameMsg: string =
		"Sorry, the git url you provided doesn't appear to be valid.";
	...
	public static FailedToSwitchAccounts: string =
		"Error occured during the switching accounts.";
	public static FailedToGenerateCrashes: string =
	...
	public static UnknownError: string =
		"An unknown error has occured. Please check the output window for more details.";
