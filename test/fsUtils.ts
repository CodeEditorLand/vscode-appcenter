...
describe("FsUtils", function () {
	...
	describe("#IsEmptyDirectoryToStartNewProject", () => {
		it("should return true if directory is empty", async () => {
			const isEmpty = FSUtils.IsEmptyDirectoryToStartNewProject(
				pathToCreateEmptyFolder
			);
	...
	describe("#exists", () => {
		...
		it("should return true if file exists", async () => {
			const exists = await FSUtils.exists(
				pathToNonEmptyDir + "/some-file.txt"
			);
